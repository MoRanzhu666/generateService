...
public class MainNoResponsePo {
    ...
    public static String generateControllerCode(String baseName) {
        ...
        return "@RestController\n" +
                ...
                "    public void addOrUpdate(@RequestBody " + addUpdateReqClassName + " req){\n" +
                "        " + serviceVarName + ".addOrUpdate(req);\n" +
                "    }\n" +
                "\n" +
                "}";
    }
    ...
    public static String generateServiceCode(String baseName) {
        ...
        return "@Service(\"" + serviceBeanName + "\")\n" +
                ...
                "    }\n"+
                "\n"+
                "    public void batchDelete(IdsRequestDTO idsRequestDTO) {\n" +
                "        // 实现批量删除逻辑\n" +
                "        if (idsRequestDTO != null && idsRequestDTO.getIds() != null) {\n" +
                "            removeByIds(idsRequestDTO.getIds());\n" +
                "        }\n" +
                "    }\n" +
                "\n" +
                "    @Transactional\n" +
                "    public void addOrUpdate(" + addUpdateReqClassName + " req) {\n" +
