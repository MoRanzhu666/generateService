...
//    private static final String DEFAULT_SAVE_DIR = System.getProperty("user.home") + File.separator + "Desktop" + File.separator + "code";
    private static final String DEFAULT_SAVE_DIR = createSaveDir();
    private static String createSaveDir() {
        LocalDateTime now = LocalDateTime.now();
        return String.format("D:\\Download\\%04d%02d%02d_%02d%02d%02d_code",
                now.getYear(),
                now.getMonthValue(),
                now.getDayOfMonth(),
                now.getHour(),
    ...
    public static String generateControllerCode(String baseName) {
        ...
        return "import com.baomidou.mybatisplus.core.metadata.IPage;\n" +
                ...
                "\n" +
                "    @PostMapping(\"/select\")\n" +
                "    public IPage<" + poClassName + "> select(@RequestBody(required = false) " + reqClassName + " filter) {\n" +
                "        if (filter == null) {\n" +
                "            filter = new " + reqClassName + "();\n" +
                "        }\n" +
                "        return " + serviceVarName + ".select(filter);\n" +
                "    }\n" +
                "\n" +
                ...
                "    public " + poClassName + " selectOne(@RequestBody(required = false) IdsRequestDTO filter) {\n" +
                "        if (filter == null) {\n" +
                "            filter = new IdsRequestDTO();\n" +
                "        }\n" +
                "        return  " + serviceVarName + ".selectOne(filter);\n" +
                "    }\n" +
                "\n" +
                "    @PostMapping(\"/addOrUpdate\")\n" +
                "    public " + addUpdateReqClassName + " addOrUpdate(@RequestBody " + addUpdateReqClassName + " req){\n" +
    ...
    public static String generateReqCode(String baseName) {
        ...
        return "import circlelog.jigsaw.lfs.common.mybatis.CustomizedPage;\n" +
    ...
    public static String generatePoCode(String baseName) {
        ...
        return "import circlelog.jigsaw.lfs.common.model.basic.onlyid.BasicDataIsolationOnlyPo;\n" +
    ...
    public static String generateServiceCode(String baseName) {
        ...
        return "import circlelog.jigsaw.lfs.common.model.exception.BadRequestException;\n" +
                "import circlelog.jigsaw.lfs.common.utils.Utils4General;\n" +
                ...
                "        if (Utils4General.isEmpty(reqId) ||  reqId.equals(\"undefined\") || reqId.equals(\"\")) {\n" +
                "            po.fillSourceInfo();\n" +
                "            po.fillCreationInfo();\n" +
                "\n" +
    ...
    public static String generateMapperCode(String baseName) {
        ...
        return "import com.baomidou.mybatisplus.core.mapper.BaseMapper;\n" +
                "import com.baomidou.mybatisplus.core.metadata.IPage;\n" +
    ...
    public static void main(String[] args) {
        ...
        System.out.print("请输入基础名称（驼峰式/小写下划线）：");
